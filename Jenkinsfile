pipeline {
  agent {
    docker {
      image 'zaralink/bugsquashers:12'
  ...
  stages {
    ...
    sed -i "s/replaceImageTag/${BUILD_NUMBER}/g" kubernetes-deployment-manifest/personal-container-artifactory/deployment.yml 
    git add kubernetes-deployment-manifest/personal-container-artifactory/deployment.yml
